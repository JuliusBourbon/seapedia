...
const { checkoutSchema, previewCheckoutSchema } = require('./order.validation');

router.post('/checkout/preview', authenticate, requireActiveRole('BUYER'), validate(previewCheckoutSchema), controller.previewCheckout);
